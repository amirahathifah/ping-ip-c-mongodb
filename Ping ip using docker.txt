...
  //create query
  auto filter = document{} << "assetsstatus"
                           << "ACTIVE" << finalize;
...
string s = "ping -c1 -s1 " + doc["assetsip"].get_utf8().value.to_string() + "> /dev/null 2>&1";
...
  string c = "curl --ssl-reqd \
  --url 'smtps://smtp.gmail.com:465' \
  --user 'azaharmyra95@gmail.com:Qwertyuiop@2395' \
  --mail-from 'azaharmyra95@gmail.com' \
  --mail-rcpt 'mirapsm95@gmail.com' \
